...
let posts: Post[] = [
  {
    id: '1',
    title: 'O Mito da Caverna na Era Digital',
    subtitle: 'Uma reflexão sobre as sombras que habitam nossas telas.',
    content: 'Platão nos convidou a imaginar prisioneiros em uma caverna, que tomam sombras por realidade. Hoje, não estamos acorrentados a uma parede, mas a telas luminosas. Nossos feeds de notícias, curados por algoritmos, são as novas sombras na parede. Será que a \'realidade\' que consumimos é apenas um reflexo distorcido, projetado para manter nossos olhos fixos e nossas mentes passivas?\n\nA fuga da caverna de Platão exigia um doloroso ajuste à luz do sol, à verdade. Qual é a nossa \'luz do sol\' hoje? É o pensamento crítico, a desconexão deliberada, a busca por fontes primárias de informação? O filósofo na alegoria de Platão tinha o dever de voltar e libertar os outros, mesmo correndo o risco de ser ridicularizado. Na nossa era de bolhas informacionais e pós-verdade, quem são os filósofos modernos? Somos nós, quando ousamos questionar o feed, desafiar nossas próprias convicções e buscar um entendimento que vai além das sombras projetadas em nossas telas.',
    author: 'Klebsu',
    authorImage: 'https://picsum.photos/seed/authorKlebsu/40/40',
    date: '2024-07-28T10:00:00Z',
    tags: ['Platão', 'Realidade', 'Tecnologia'],
    imageUrl: 'https://picsum.photos/seed/post1/1200/800',
    imageHint: 'sombras abstratas',
  },
  {
    id: '2',
    title: 'O Eterno Retorno de Nietzsche em um Mundo de "Stories"',
    subtitle: 'Você abraçaria a repetição infinita da sua vida?',
    content: 'Imagine que cada momento de sua vida, de sua maior alegria ao seu mais profundo desespero, se repetirá infinitamente. Esta é a ideia do \'eterno retorno\' de Nietzsche, um experimento mental para avaliar a vida. Você abraçaria essa repetição com alegria ou a veria como uma maldição?\n\nAgora, considere a natureza efêmera de nossa cultura digital. \'Stories\' que desaparecem em 24 horas, tendências que duram uma semana. Vivemos em um fluxo constante de novidade e esquecimento. O que Nietzsche diria sobre uma cultura que parece fugir ativamente da permanência? Talvez o \'eterno retorno\' seja um antídoto necessário. Ele nos força a viver de uma maneira que valha a pena ser repetida. Se cada post, cada interação, cada momento de scroll infinito fosse ecoar pela eternidade, faríamos as mesmas escolhas? A pergunta não é se a vida se repete, mas se estamos vivendo uma vida que gostaríamos que se repetisse.',
    author: 'Klebsu',
    authorImage: 'https://picsum.photos/seed/authorKlebsu/40/40',
    date: '2024-07-25T14:30:00Z',
    tags: ['Nietzsche', 'Existencialismo', 'Vida Digital'],
    imageUrl: 'https://picsum.photos/seed/post2/1200/800',
    imageHint: 'relógio espiral',
  },
  {
    id: '3',
    title: 'Sísifo no Escritório: Encontrando Sentido no Trabalho Moderno',
    subtitle: 'Como encontrar propósito em tarefas repetitivas?',
    content: 'Albert Camus reimaginou o mito de Sísifo — condenado a rolar uma pedra montanha acima para sempre — como um herói absurdo. Sísifo encontra sentido em sua tarefa inútil ao se rebelar contra sua condição através da consciência e do desprezo. Quantos de nós se sentem como Sísifo em nossos trabalhos, presos em tarefas repetitivas que parecem não ter um propósito maior?\n\nO trabalho moderno, com suas métricas de produtividade e burocracia, muitas vezes nos aliena do fruto de nosso esforço. Mas Camus nos oferece uma saída. Não se trata de encontrar um \'trabalho dos sonhos\', mas de transformar nossa relação com o trabalho que temos. Podemos, como Sísifo, \'imaginar Sísifo feliz\' ao reivindicar nossa autonomia mental. É encontrar pequenos atos de rebelião, de criatividade, de conexão humana dentro da estrutura. É reconhecer o absurdo da tarefa e, mesmo assim, escolher realizá-la com dignidade e consciência. O sentido não está na pedra, mas na atitude com que a rolamos.',
    author: 'Klebsu',
    authorImage: 'https://picsum.photos/seed/authorKlebsu/40/40',
    date: '2024-07-22T11:00:00Z',
    tags: ['Camus', 'Absurdo', 'Trabalho'],
    imageUrl: 'https://picsum.photos/seed/post3/1200/800',
    imageHint: 'homem escritório',
  },
  {
    id: '4',
    title: 'A "Vontade de Potência" e a Economia do Like',
    subtitle: 'A busca por auto-superação versus a busca por validação externa.',
    content: 'Para Nietzsche, a força motriz fundamental da vida não era a sobrevivência, mas a \'vontade de potência\' — o impulso inato de crescer, expandir, dominar e se auto-superar. Como essa ideia se manifesta na era das redes sociais? Cada like, cada compartilhamento, cada novo seguidor pode ser visto como uma pequena afirmação de nossa potência, uma expansão de nossa influência digital.\n\nEstamos exercendo nossa vontade de potência ou estamos sendo manipulados por um sistema que a explora? As plataformas são projetadas para nos dar pequenas doses de validação, nos mantendo engajados e buscando mais. A busca por auto-superação se transforma em uma busca por validação externa. O \'super-homem\' de Nietzsche era aquele que criava seus próprios valores, independente da aprovação da multidão. No entanto, na economia do like, a aprovação da multidão é a moeda corrente. Estamos nos tornando mais fortes e mais autônomos, ou estamos nos tornando mais dóceis, moldados pelas métricas de engajamento que governam nossas vidas online?',
    author: 'Klebsu',
    authorImage: 'https://picsum.photos/seed/authorKlebsu/40/40',
    date: '2024-07-20T09:00:00Z',
    tags: ['Nietzsche', 'Poder', 'Mídia Social'],
    imageUrl: 'https://picsum.photos/seed/post4/1200/800',
    imageHint: 'corações mídia social',
  },
  {
    id: '5',
    title: 'A Verdade é Descoberta ou Criada?',
    subtitle: 'Não há fatos, apenas interpretações.',
  ...
  },
  {
    ...
    subtitle: 'Por que parece "algo" ser você?',
  ...
  },
  {
    ...
    subtitle: 'Se não há Deus, pode haver uma base objetiva para a moralidade?',
  ...
  },
  {
    ...
    subtitle: 'Os limites da minha linguagem significam os limites do meu mundo.',
